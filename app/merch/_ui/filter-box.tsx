...
export default function FilterBox({
  ...
  return (
    <div className="relative mb-7">
      {/* Filter Menu */}
      <div className="lg:w-auto border border-coffee py-1 px-3 items-center flex justify-center space-x-8 mt-5 rounded-lg">
        {filterMenu.map((m) => (
          <div
          ...
          >
            <p className="text-coffee text-xs uppercase select-none">
              {m.replace("-", " ")}
            </p>
            <svg
      ...
      >
        <p
          ...
          } py-2 px-4 font-bold underline lg:text-sm text-xs cursor-pointer select-none`}
          onClick={() => {
            clearFilter();
