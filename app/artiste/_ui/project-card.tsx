    ...
    <div className="bg-opacity-40 p-10 flex flex-col items-center group hover:bg-awg-yellow hover:bg-opacity-90 transition-colors duration-500 ease-in-out w-[350px] lg:w-[450px] bg-white lg:mx-4 text-black uppercase">
      <div className="group-hover:-translate-x-6  transition transform duration-[1000ms] ease-in-out relative">
        <img
          src={art}
          alt="uncon"
          className="mb-8 w-[120px] h-[120px] lg:w-[100px] lg:h-[100px] z-10 relative"
        />
      ...
      <Link href={link ?? "https://example.com"}>
        <p className="text-lg mb-4 font-semibold text-center tracking-wider group-hover:underline">
          {title}
        </p>
      </Link>
