...
export default function HeroGrid() {
  return (
    <div className="flex lg:flex-row flex-col-reverse lg:items-start items-center justify-between py-6 w-full">
      <div className="flex flex-col lg:justify-start items-center lg:items-start w-full">
        <Image src="/gang/gang1.jpg" width={600} height={350} alt="gang1" />
